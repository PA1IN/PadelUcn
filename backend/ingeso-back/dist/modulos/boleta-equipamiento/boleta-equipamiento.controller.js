...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Crear una nueva boleta de equipamiento' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Boleta creada exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos inválidos o stock/saldo insuficiente' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todas las boletas de equipamiento' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de boletas obtenida exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'No autorizado' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Obtener una boleta de equipamiento por su ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Boleta obtenida exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Boleta no encontrada' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'No autorizado' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Actualizar una boleta de equipamiento existente' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Boleta actualizada exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Boleta no encontrada' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos inválidos o stock/saldo insuficiente' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'No autorizado' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Eliminar una boleta de equipamiento' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Boleta eliminada exitosamente' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Boleta no encontrada' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'No autorizado' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener todas las boletas de equipamiento de una reserva' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Lista de boletas obtenida exitosamente' }),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], BoletaEquipamientoController.prototype, "findByReserva", null);
exports.BoletaEquipamientoController = BoletaEquipamientoController = __decorate([
    (0, swagger_1.ApiTags)('boleta-equipamiento'),
