...
export declare class AuthController {
    ...
    login(loginDto: LoginDto): Promise<import("../../interface/Apiresponce").ApiResponse<null> | import("../../interface/Apiresponce").ApiResponse<import("./dto/auth.dto").LoginResponseDto>>;
